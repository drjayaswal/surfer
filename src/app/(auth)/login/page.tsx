  ...
  const createAccount = async (userData: FormData): Promise<boolean> => {
    try {
      ...
      if (!otpResponse.success) {
        setErrors({ general: otpResponse.message || "Failed to send OTP" });
        return false;
      }
              ...
              {index < steps.length - 1 && (
                <div
                  className={cn(
                    ...
                    index < currentStepIndex ? "bg-sky-600" : "bg-gray-200"
                  )}
                />
              )}
            </React.Fragment>
                          ...
                          <div className="space-y-2">
                            <div className="relative">
                              ...
                              <Input
                                ...
                                className={cn(
                                  "pl-10 h-12 focus-visible:border-sky-500 focus-visible:ring-0 rounded-xl border-0 bg-gray-50",
                                  errors.email &&
                          ...
                          <div className="space-y-2">
                            <div className="relative">
                              ...
                              <Input
                                ...
                                className={cn(
                                  "pl-10 pr-10 h-12 focus-visible:border-sky-500 focus-visible:ring-0 rounded-xl border-0 bg-gray-50",
                                  errors.password &&
                                    "border-red-300 focus:border-red-400"
                                )}
                  ...
                  {authStep === "forgot-password" && (
                    ...
                    >
                      {isLoading ? (
                        ...
                        <>
                          <div className="text-center mb-6">
                            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-sky-500 to-sky-600 rounded-2xl mb-4 shadow-lg shadow-sky-500/25">
                      ...
                      {isLoading ? (
                        ...
                        <>
                          <div className="text-center mb-6">
                            ...
                            <div className="inline-flex items-center px-3 py-1 bg-sky-100 rounded-full">
                              <span className="text-sm text-gray-600">
                                Code sent to:{" "}
                              </span>
                              <span className="ml-1 font-medium text-gray-900 truncate max-w-[150px]">
                                {formData.email}
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                              <Input
                                ...
                                className={cn(
                                  "h-12 focus-visible:border-sky-500 focus-visible:ring-0 rounded-xl border-0 bg-gray-50",
                                  errors.lastName &&
                                    "border-red-300 focus:border-red-400"
                                )}
