...
;
;
function SearchBar({ onSearch, placeholder = "Ask me anything...", className = "" }) {
    _s();
        ...
        "SearchBar.useEffect": ()=>{
            if (searchQuery.trim()) {
                ...
                const filtered = suggestions.filter({
                    "SearchBar.useEffect.filtered": (suggestion)=>{
                ...
                const categorized = [
                    ...suggestions.filter({
                        "SearchBar.useEffect": (s)=>s.category === "trending"
                    }["SearchBar.useEffect"]).slice(0, 2),
                    ...suggestions.filter({
                        "SearchBar.useEffect": (s)=>s.category === "popular"
                    }["SearchBar.useEffect"]).slice(0, 2),
                    ...suggestions.filter({
                        "SearchBar.useEffect": (s)=>s.category === "suggested"
                    }["SearchBar.useEffect"]).slice(0, 2)
                ];
    ...
    const handleKeyDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SearchBar.useCallback[handleKeyDown]": (e)=>{
            if (!showSuggestions) return;
            switch(e.key){
                case "ArrowDown":
                    e.preventDefault();
                    setSelectedIndex({
                        "SearchBar.useCallback[handleKeyDown]": (prev)=>prev < filteredSuggestions.length - 1 ? prev + 1 : prev
                    }["SearchBar.useCallback[handleKeyDown]"]);
                    break;
                case "ArrowUp":
                    e.preventDefault();
                    setSelectedIndex({
                        "SearchBar.useCallback[handleKeyDown]": (prev)=>prev > 0 ? prev - 1 : -1
                    }["SearchBar.useCallback[handleKeyDown]"]);
                    break;
                case "Enter":
                    e.preventDefault();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SearchBar.useEffect": ()=>{
            ...
            return ({
                "SearchBar.useEffect": ()=>document.removeEventListener("keydown", handleKeyDown)
            })["SearchBar.useEffect"];
        }
    }["SearchBar.useEffect"], [
        handleKeyDown
...
_s(SearchBar, "7FhS4oKNxIf1qtLBxF/hbEOnju4=");
_c = SearchBar;
var _c;
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: "© 2025 SURFER. All rights reserved."
                    }, void 0, false, {
                        fileName: "[project]/src/components/footer.tsx",
                        lineNumber: 80,
                        columnNumber: 11
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            const timer = setInterval({
                "Home.useEffect.timer": ()=>setCurrentTime(new Date())
        ...
        "Home.useEffect": ()=>{
            const interval = setInterval({
                "Home.useEffect.interval": ()=>{
                    ...
                    setTimeout({
                        "Home.useEffect.interval": ()=>setIsWaveActive(false)
...
_s(Home, "9sI0CTUNi/EJDViZ2Qf/+HdwAEQ=");
_c = Home;
var _c;
...
//# sourceMappingURL=src_9587519b._.js.map